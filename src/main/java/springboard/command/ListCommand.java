...
public class ListCommand implements BbsCommandImpl{
	...
	public void execute(Model model) {
		...
		{	
			...
			/*
			 * //전체게시물의 갯수에서 하나씩 차감하면서 가상번호 부여 virtualNum = totalRecordCount --; //setter를
			 * 통해 저장 row.setVirtualNum(virtualNum);
			 */
		}
